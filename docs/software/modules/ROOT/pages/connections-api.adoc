...
image::connection_metadata_json.png[Connection metadata]
...
* `user`
+
_String_. The username of your Oracle ADW account.
...
* `user`
+
_String_. The username of your SAP HANA database account.
...
include::partial$data-connection-apis.adoc[]
