...
The REST v2 API endpoints[beta betaBackground]^Beta^ are categorized based on the type of object they operate on. The REST v2 framework includes the following resource collections and endpoints.
