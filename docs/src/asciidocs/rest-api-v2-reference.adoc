...
`*POST* /tspublic/rest/v2/metadata/tag/assign`
...
`*POST* /tspublic/rest/v2/metadata/tag/unassign`
...
== Security [tag greenBackground]#NEW in 8.3.0.cl#
...
== Custom actions [tag greenBackground]#NEW in 8.3.0.cl#
