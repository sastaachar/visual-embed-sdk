...
--
Starting from the ThoughtSpot Cloud 9.0.0.cl release, the REST API v2 [beta betaBackground]^Beta^ endpoints will be deprecated and removed from the REST API v2 Playground. For more information, see xref:deprecated-features.adoc#_deprecation_of_rest_v2_api[Deprecation announcements].
--
