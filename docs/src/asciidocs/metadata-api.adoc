...
The metadata APIs allow you to query metadata objects from the ThoughtSpot system. The metadata objects include search answers, pinboards, visualizations, and data objects such as tables, worksheets, and views. You can also query metadata objects for a user or user group configured in ThoughtSpot. 
...
The API returns a list of visualizations for a given pinboard or search answer.
