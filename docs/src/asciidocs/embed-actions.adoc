...
For a complete list of menu actions and the corresponding strings to use for disabling or hiding an action, see link:https://docs.thoughtspot.com/visual-embed-sdk/release/typedoc/enums/action.html[Action, window=_blank] or below in the Supported menu actions section.
