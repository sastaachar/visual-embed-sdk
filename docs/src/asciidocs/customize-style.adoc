...
For more information on setting UI styles from the *Admin* console, see link:https://docs.thoughtspot.com/latest/admin/admin-portal/style-customization.html[Style Customization].
