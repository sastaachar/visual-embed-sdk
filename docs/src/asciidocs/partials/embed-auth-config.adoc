...
+
__String__. Allows adding a redirect path string to the host origin. If this attribute is configured, the SAML SSO authentication flow will be terminated on the specified redirect path. 
