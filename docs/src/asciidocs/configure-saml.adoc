...
[NOTE]
====
ThoughtSpot can also add users to groups sent within the SAML assertion. To enable and configure the SAML groups capabilities, contact ThoughtSpot Support.
====
+
. Click *Save*.
