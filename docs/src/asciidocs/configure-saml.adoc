...
If you select *no*, the SAML users will not be added in ThoughtSpot upon first successful SSO login. Instead, you must  link:https://docs.thoughtspot.com/latest/admin/users-groups/add-user.html[add users manually, window=_blank].
+
. Click *Save*.
