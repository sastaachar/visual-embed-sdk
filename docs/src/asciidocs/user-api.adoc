...
When a user is removed from the ThoughtSpot application, you may want to transfer objects from the deleted user account to the account. Administrators can programmatically transfer the ownership of one or several objects from one user to another via  `/tspublic/v1/user/transfer/ownership` API endpoint.
...
|`objectsID`|__Array of strings__. A JSON array of ThoughtSpot object IDs. For example,`[7589cbdb-eb50-4d8c-89e7-08e8f4573a5d,84481cda-f92e-4ba5-a1ef-366eb61017f5]`.
|====
