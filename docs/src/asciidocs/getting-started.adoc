...
You can access Visual Embed SDK package at link:https://www.npmjs.com/package/@thoughtspot/visual-embed-sdk[https://www.npmjs.com/package/@thoughtspot/visual-embed-sdk, window=_blank].
...
[NOTE]
====
If your cluster is running ThoughtSpot Software version 7.1.0, make sure you download and install the Visual Embed SDK 1.2.0 NPM package. 
====
