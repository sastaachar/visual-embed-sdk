...
a|xref:feature-matrix-license.adoc#_rest_api_v1_operations[REST API v1]
...
a|xref:feature-matrix-license.adoc#_rest_api_v2_0_operations[REST API v2] |[tag greenBackground]#✓#  +
(Basic authentication only) |[tag greenBackground]#✓# |[tag greenBackground]#✓#  +
(Basic authentication only) |[tag greyBackground]#–#

|REST API Playground |[tag greenBackground]#✓#  | [tag greenBackground]#✓# |[tag greenBackground]#✓# |[tag greenBackground]#✓#
...
|Basic style customization (UI workflow)|[tag greenBackground]#✓# |[tag greenBackground]#✓# |[tag greyBackground]#–# |[tag greyBackground]#–#
|Custom CSS|[tag greyBackground]#–#|[tag greenBackground]#✓# |[tag greyBackground]#–# |[tag greyBackground]#–#
...
[options='header']
|=====
|REST API v2.0 endpoints |ThoughtSpot Enterprise Cloud Service|ThoughtSpot Everywhere Edition License|Free Trial account +
(Evaluation only) |Developer Playground on public instance +
(Evaluation only)
