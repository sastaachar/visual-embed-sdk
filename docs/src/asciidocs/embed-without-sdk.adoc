...
To apply runtime filters, add filters to the URL.

For example, to apply the `michigan` filter on the `State` column, add `&col1=State&op1=EQ&val1=michigan` as query parameters in the URL:
