...
* `A3ANALYSIS`
* `BYPASSRLS`
|`grouptype` __Optional__ a|__String__. Type of user group. The default value is `LOCAL_GROUP`, which indicates that the user group is created locally in the ThoughtSpot system.    
