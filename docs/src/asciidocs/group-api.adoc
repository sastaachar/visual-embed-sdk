...
|`visibility` +
__Optional__|__String__. Visibility of the user group. The `visibility` attribute is set to `DEFAULT`. The `DEFAULT` attribute makes the group visible to other user groups and allows them to share objects.  
|===
