...
The search answer data returned in the API response contains four components:
...
A sampling ratio of `1` indicates that all data in the search answer object was returned in the API response.
