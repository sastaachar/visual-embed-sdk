...
Effective from the ThoughtSpot 8.4.0-sw (Limited Availability) release, ThoughtSpot pinboards are rebranded as Liveboards in ThoughtSpot UI, documentation, and learning resources.
