...
[#search-answer-payload]
=== Search answer payload

The following example shows the visualization data payload for a callback custom action in a search answer page:
////
[source, JSON]
----
{
...
The following example shows the cell-level data payload for a callback custom action set as a context menu in a search answer page:
