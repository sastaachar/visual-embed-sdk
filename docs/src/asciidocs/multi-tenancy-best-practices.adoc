...
Any user with __Share with all__ privilege, including administrators, can share objects with any group regardless of the __shareable__ property. The non-admin users can only share to:
