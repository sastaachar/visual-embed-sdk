...
[NOTE]
====
The `LiveboardRendered` event is triggered when the Liveboard shell loads. The data on the Liveboard visualizations are loaded asynchronously and may not be loaded fully when the event is emitted.
====
