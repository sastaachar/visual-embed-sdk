...
[NOTE]
====
Starting from the 8.4.1-sw release, ThoughtSpot Software clusters support ThoughtSpot Everywhere features and embedding with Visual Embed SDK. For more information about features and enhancements introduced in ThoughtSpot Software releases, see the Release Notes documentation available from the *Guides* menu in the *Develop* tab.
====
