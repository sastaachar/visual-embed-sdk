...
.. Wait until your request is approved by the Slack workspace administrator. You will receive a notification via email and Slackbot when your request is approved.
+
