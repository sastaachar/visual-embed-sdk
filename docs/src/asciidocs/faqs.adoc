...
* xref:rest-api-v2-reference.adoc[REST API v2.0 Reference][beta betaBackground]^Beta^
...
You can also view and download the REST API v2.0 code samples from the link:{{previewPrefix}}/api/rest/playgroundV2[REST API v2.0 Playground, window=_blank][beta betaBackground]^Beta^.
====
