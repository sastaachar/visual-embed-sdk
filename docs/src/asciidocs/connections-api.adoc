...
This article describes the procedures for setting and managing data connections through the REST APIs. For information about how to set up a data connection in the ThoughtSpot UI, see link:https://docs.thoughtspot.com/software/latest/connections[Connections, window=_blank].
...
* `user`
+
_String_. The username of your Redshift account.
...
* `user`
+
_String_. The username of your Azure Synapse account.
...
* `user`
+
_String_. The username of your Teradata account.
...
* `user`
+
_String_. The username of your Starburst account.
...
* `user`
+
_String_. The username of your Databricks account.
...
* `password`
+
__String__. Password of the SAP HANA database account.
