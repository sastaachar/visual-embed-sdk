...
////
Before using these APIs, make sure the data connection is set up. For information about how to set up a data connection to an external database and link it as a data source, see link:https://cloud-docs.thoughtspot.com/admin/ts-cloud/embrace.html[https://cloud-docs.thoughtspot.com/admin/ts-cloud/embrace.html, window=_blank].
////
