...
This changelog tracks only changes to the SDK and API. For information about the changes introduced in the Developer portal or ThoughtSpot application, see the link:https://docs.thoughtspot.com/release/notes.html[ThoughtSpot Cloud Release Notes, window=_blank]. 
