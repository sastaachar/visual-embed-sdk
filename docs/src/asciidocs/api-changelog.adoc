...
For more information, see xref:events-ref.adoc[Events reference].
|[tag orangeBackground]#MODIFIED# |The SDK supports omitting or executing a search query in xref:events-ref.adoc#hostEventSearch[`HostEvent.Search`].
