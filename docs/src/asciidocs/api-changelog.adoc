...
|[tag greenBackground]#NEW FEATURE# a| The `Action.CreateMonitor` enumeration will be available in the SDK for embedded ThoughtSpot environments on which the Monitor feature is enabled.
