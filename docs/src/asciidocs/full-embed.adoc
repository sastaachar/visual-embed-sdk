...
----
frameParams:: Sets the `width` and `height` dimensions to render ThoughtSpot pages in your application. You can set the `width` and `height` attribute values in pixels or as a percentage.
