...
|====
||
|[tag greenBackground]#NEW ENDPOINTS#  a| The following REST API v2[beta orangeBackground]^BETA^ endpoints will be available soon:
...
* The HTTP request method for the following REST v2 API [beta orangeBackground]^BETA^ endpoints will be changed `PUT`.
