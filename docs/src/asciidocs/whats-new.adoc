...
This API allows you to securely send the login token and user information in the request body. For more information, see the xref:session-api.adoc#session-loginToken[REST API reference page].
...
|====
||
|[tag orangeBackground]#MODIFIED# |+++<h5>Search data</h5>+++ 
...
|[tag greenBackground]#NEW FEATURE# |+++<h5>Visualization actions</h5>+++
