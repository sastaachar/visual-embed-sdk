...
* The classes corresponding to enumerations used for string fields in the SDK, such as the `type` field in metadata API, are renamed. If you are using the REST API SDK in your environments, make sure the class names are updated.
