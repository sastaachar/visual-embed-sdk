...
The Visual Embed SDK allows applying runtime filters on embedded Liveboard, visualization, and Answer objects. In the full app embed mode, ThoughtSpot applies runtime filters on all Liveboard, visualization, and Answer objects in the embedded app.
