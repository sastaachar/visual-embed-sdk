...
[IMPORTANT]
====
* The Orgs multi-tenancy features require the link:https://www.thoughtspot.com/pricing[ThoughtSpot Analytics Enterprise Edition license, window=_blank] or link:https://www.thoughtspot.com/pricing[ThoughtSpot Everywhere Enterprise Edition licence, window=_blank]. 
* The Orgs feature is disabled by default on ThoughtSpot clusters. To enable this feature on your instance, contact ThoughtSpot Support.
