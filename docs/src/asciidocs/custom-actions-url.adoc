...
* Make sure the new Answer experience is enabled on your cluster. Contact ThoughtSpot Support if the new Answer Experience is not enabled on your cluster.
