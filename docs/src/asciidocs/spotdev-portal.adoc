...
The ThoughtSpot Developer portal allows you to explore Visual Embed SDK and build your web applications with ThoughtSpot content.
The portal helps business application owners and developers to learn about ThoughtSpot APIs, and evaluate ThoughtSpot features that are available for integration.
...
* *Actions*
+
Provides UI workflows to create custom actions in the ThoughtSpot UI. For example, you can a create an action that triggers a callback to your host application, or invoke a URL to send ThoughtSpot data. For more information, see xref:custom-actions.adoc[Custom actions].
